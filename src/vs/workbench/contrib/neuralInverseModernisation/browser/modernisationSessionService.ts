...
export const MIGRATION_PATTERN_PRESETS: IMigrationPatternPreset[] = [
	...
	{ id: 'fortran-migration',            category: 'Mainframe & Legacy Language', label: 'FORTRAN Migration',                    description: 'Migrate FORTRAN 77/90/95/2003 scientific and engineering programs to Python (NumPy/SciPy) or modern C++.',           topology: { ...T_ONE_ONE,   sourceLabel: 'FORTRAN Program',   targetLabel: 'Modern Project' } },
	{ id: 'delphi-migration',             category: 'Mainframe & Legacy Language', label: 'Delphi / Pascal Migration',            description: 'Migrate Delphi VCL applications and Object Pascal code to modern .NET, Java, or web-based equivalents.',            topology: { ...T_ONE_ONE,   sourceLabel: 'Delphi Application', targetLabel: 'Modern Application' } },
	{ id: 'mumps-migration',              category: 'Mainframe & Legacy Language', label: 'MUMPS / M Migration',                  description: 'Migrate MUMPS/InterSystems Cache/IRIS code to Python or modern object-oriented equivalents.',                       topology: { ...T_ONE_ONE,   sourceLabel: 'MUMPS Program',     targetLabel: 'Modern Project' } },
	{ id: 'ada-migration',                category: 'Mainframe & Legacy Language', label: 'Ada Migration',                        description: 'Migrate Ada 83/95/2005/2012 programs to modern C++, Rust, or Java, preserving strong typing contracts.',             topology: { ...T_ONE_ONE,   sourceLabel: 'Ada Program',       targetLabel: 'Modern Program' } },
	{ id: 'powerbuilder-migration',       category: 'Mainframe & Legacy Language', label: 'PowerBuilder Migration',               description: 'Migrate PowerBuilder DataWindow-based client/server applications to Java Spring or modern web frameworks.',          topology: { ...T_ONE_ONE,   sourceLabel: 'PowerBuilder Application', targetLabel: 'Modern Application' } },
	{ id: 'abap-migration',               category: 'Mainframe & Legacy Language', label: 'SAP ABAP Migration',                   description: 'Migrate SAP ABAP reports, BAPIs, and BAdIs to SAP CAP, REST APIs, or off-SAP microservices.',                       topology: { ...T_ONE_ONE,   sourceLabel: 'ABAP Program',      targetLabel: 'Modern Service' } },
	// Database
	...
	{ id: 'jquery-to-react',             category: 'Framework & Language',        label: 'jQuery -> React / Vue',               description: 'Replace jQuery DOM manipulation and AJAX calls with a component-based React or Vue 3 architecture.',              topology: { ...T_ONE_ONE,   sourceLabel: 'jQuery Application', targetLabel: 'Component Application' } },
	// Architecture style
