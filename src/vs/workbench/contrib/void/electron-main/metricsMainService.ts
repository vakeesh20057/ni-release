...
export class MetricsMainService extends Disposable implements IMetricsService {
	...
	constructor(
		...
		super()
		this.client = new PostHog('phc_urVior2rWRDWzn8Q4t2bjjxbKeeBY3yUcLQRtPqYdyXK', {
	...
	async initialize() {
		...
		console.log('User is opted out of basic NeuralInverse metrics?', didOptOut)
		if (didOptOut) {
			this.client.optOut()
		}
		else {
		...
		console.log('NeuralInverse posthog metrics info:', JSON.stringify(identifyMessage, null, 2))
	}
